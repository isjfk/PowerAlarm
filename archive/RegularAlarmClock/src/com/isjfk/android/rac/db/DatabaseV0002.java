 ...
 */
public class DatabaseV0002 implements Database {
    ...
    public void upgrade(Context context, SQLiteDatabase db) {
        String ringtone = RingtoneConfig.encode(BeanFactory.newRingtoneConfig());

        db.execSQL("ALTER TABLE alarmrule ADD COLUMN ringtone");
        db.execSQL("UPDATE alarmrule SET ringtone='" + ringtone + "'");
    }
